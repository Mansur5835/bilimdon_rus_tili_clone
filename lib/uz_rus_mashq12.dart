...
class UzRusMashq12 extends StatefulWidget {
  const UzRusMashq12({Key? key}) : super(key: key);

  @override
  _UzRusMashq12State createState() => _UzRusMashq12State();
}

class _UzRusMashq12State extends State<UzRusMashq12> {
  ...
  List<String> list = MyHelper(
          s: "Написал (napisal) - Yozdim(erkak)",
          s1: "Написала (napisala) - Yozdim(ayol)",
          s2: "Написали (napisali) - Yosdik(ko`plik)",
          s3: "Пишу (pishu) - Yozyapman",
          s4: "Напишу (napishu) - Yozaman",
          s5: "Сплю (splyu) - Uxlayapman",
          s6: "Буду-спать (budu-spat) - Uxlayman",
          s7: "Ждём (jdеm) - Kutyapmiz",
          s8: "Спрашивать (sprashivat) - So`rash",
          s9: "Иду (idu) - Boryapman",
          s10: "Опаздывать (opazdivat) - Kechikish")
      .uzPerevodRus();
