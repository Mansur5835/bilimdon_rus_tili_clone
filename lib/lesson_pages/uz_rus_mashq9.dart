...
class UzRusMash19 extends StatefulWidget {
  const UzRusMash19({Key? key}) : super(key: key);

  @override
  _UzRusMash19State createState() => _UzRusMash19State();
}

class _UzRusMash19State extends State<UzRusMash19> {
  ...
  List<String> list = MyHelper(
          s: "Желтый (joltiy) - Sariq",
          s1: "Красный (krasniy) - Qizil",
          s2: "Цвет (tsvet) - Rang",
          s3: "Черный (chorniy) - Qora",
          s4: "Коричневый (korichneviy) - Jigarrang",
          s5: "Синый (siniy) - Ko`k",
          s6: "Золотой-цвет (zolotoy-tsvet) - Tilla-rang",
          s7: "Прямоугольник (pryamugolnik) - To`rtburchak",
          s8: "Треугольник (treugolnik) - Uchburchak",
          s9: "Точка (tochka) - Nuqta",
          s10: "Круг (krug) - Doira")
      .uzPerevodRus();
