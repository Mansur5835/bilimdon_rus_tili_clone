...
class RusUzMashq13 extends StatefulWidget {
  const RusUzMashq13({Key? key}) : super(key: key);

  @override
  _RusUzMashq13State createState() => _RusUzMashq13State();
}

class _RusUzMashq13State extends State<RusUzMashq13> {
  @override
