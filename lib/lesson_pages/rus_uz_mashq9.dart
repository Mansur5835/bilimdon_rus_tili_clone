...
class RusUzMashq9 extends StatefulWidget {
  const RusUzMashq9({Key? key}) : super(key: key);

  @override
  _RusUzMashq9State createState() => _RusUzMashq9State();
}

class _RusUzMashq9State extends State<RusUzMashq9> {
  ...
  List<String> list = MyHelper(
          ...
          s7: "Треугольник (treugolnik) - Uchburchak",
          s8: "Прямоугольник (pryamugolnik) - To`rtburchak",
