...
class UzRusMashq15 extends StatefulWidget {
  const UzRusMashq15({Key? key}) : super(key: key);

  @override
  _UzRusMashq15State createState() => _UzRusMashq15State();
}

class _UzRusMashq15State extends State<UzRusMashq15> {
  ...
  List<String> list = MyHelper(
          s: "Читать (chitat) - Yozish",
          s1: "Работать (rabotat) - Ishlash",
          s2: "Спать (spat) - Uxlash",
          s3: "Заниматься (zanimatsya) - Shug`ullanish",
          s4: "Видеть (videt) - Ko`rish",
          s5: "Писать (pisat) - Yozish",
          s6: "Обедать (obedat) - Tushlik-qilish",
          s7: "Играть (igrat) - O`ynash",
          s8: "Покупать (pokupat) - Sotib-olish",
          s9: "Продавать (prodavat) - Sotish",
          s10: "Слушать (slushat) - Eshitish")
      .uzPerevodRus();
