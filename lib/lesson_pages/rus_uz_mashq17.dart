...
class RusUzMashq17 extends StatefulWidget {
  const RusUzMashq17({Key? key}) : super(key: key);

  @override
  _RusUzMashq17State createState() => _RusUzMashq17State();
}

class _RusUzMashq17State extends State<RusUzMashq17> {
  @override
  ...
  List<String> list = MyHelper(
          s: "Глаз (glaz) - Ko`z",
          s1: "Голова (golova) - Bosh",
          s2: "Губы (gubi) - Lablar",
          s3: "Горло (gorlo) - Tomoq",
          s4: "Зуб (zub) - Tish",
          s5: "Лёгкие (lyogkiye) - O`pka",
          s6: "Мозки (mozgi) - Miya",
          s7: "Ноготь (nogot) - Tirnoq",
          s8: "Нос (nos) - Burun",
          s9: "Печен (pechen) - Jigar",
          s10: "Поясница (poyasnitsa) - Bel")
      .rusPerevodUz();
