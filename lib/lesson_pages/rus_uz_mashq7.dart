...
class RusUzMashq7 extends StatefulWidget {
  const RusUzMashq7({Key? key}) : super(key: key);

  @override
  _RusUzMashq7State createState() => _RusUzMashq7State();
}

class _RusUzMashq7State extends State<RusUzMashq7> {
