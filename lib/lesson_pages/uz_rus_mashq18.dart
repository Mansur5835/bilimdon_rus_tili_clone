...
class UzRusMashq18 extends StatefulWidget {
  const UzRusMashq18({Key? key}) : super(key: key);

  @override
  _UzRusMashq18State createState() => _UzRusMashq18State();
}

class _UzRusMashq18State extends State<UzRusMashq18> {
  ...
  List<String> list = MyHelper(
          s: "Буря (burya) - Boron",
          s1: "Вечер (vecher) - Kechki-payt",
          s2: "Вода (voda) - Suv",
          s3: "Вдопад (vodopad) - Sharshara",
          s4: "Воздух (vozdux) - Havo",
          s5: "Гора (gora) - Tog`",
          s6: "Дождь (dojd) - Yomg`ir",
          s7: "Дарога (doroga) - Yo`l",
          s8: "Звезда (zvezda) - Yulduz",
          s9: "Луна (luna) - Oy",
          s10: "Озеро (ozero) - Ko`l")
      .uzPerevodRus();
  yangi() {
    setState(() {
