...
class UzRusMashq7 extends StatefulWidget {
  const UzRusMashq7({Key? key}) : super(key: key);

  @override
  _UzRusMashq7State createState() => _UzRusMashq7State();
}

class _UzRusMashq7State extends State<UzRusMashq7> {
  ...
  List<String> list = MyHelper(
          s: "Одиннадцать (odinatsat) - O`n-bir",
          s1: "Десять (desyat) - O`n",
          s2: "Двадцвть-один (dvatsat-odin) - Yigirma-bir",
          s3: "Пять (pyat) - Besh",
          s4: "Шестьдесять (shestdesyat) - Oltmish",
          s5: "Сто-один (sto-odin) - Bir-yuz-bir",
          s6: "Четыреста (chetiresta) - To`rt-yuz",
          s7: "Девятый (devyatiy) - To`qqizinchi",
          s8: "Одиннадцатый (odinatsitiy) - O`n-birinchi",
          s9: "Шестьсот (shestsot) - Olti-yuz",
          s10: "Четыре (chetiri) - To`rt")
      .uzPerevodRus();
