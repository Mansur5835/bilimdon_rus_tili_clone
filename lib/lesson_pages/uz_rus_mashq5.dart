...
class UzRusMashq5 extends StatefulWidget {
  const UzRusMashq5({Key? key}) : super(key: key);

  @override
  _UzRusMashq5State createState() => _UzRusMashq5State();
}

class _UzRusMashq5State extends State<UzRusMashq5> {
  ...
  List<String> list = MyHelper(
          s: "Отпуск (otpusk) - Ta`til",
          s1: "Неделя (nedelya) - Hafta",
          s2: "Остров (ostrov) - Orol",
          s3: "Летать (letat) - Uchmoq",
          s4: "Багаж (bagaj) - Yuk",
          s5: "Кошелек (kashelyoq) - Xamyon",
