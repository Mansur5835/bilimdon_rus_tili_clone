...
class RusUzMashq5 extends StatefulWidget {
  const RusUzMashq5({Key? key}) : super(key: key);

  @override
  _RusUzMashq5State createState() => _RusUzMashq5State();
}

class _RusUzMashq5State extends State<RusUzMashq5> {
