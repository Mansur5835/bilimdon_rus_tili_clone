...
class UzRusMashq2 extends StatefulWidget {
  const UzRusMashq2({Key? key}) : super(key: key);

  @override
  _UzRusMashq2State createState() => _UzRusMashq2State();
}

class _UzRusMashq2State extends State<UzRusMashq2> {
  ...
  List<String> list = [
    "Salom Здрасвуйте Нет Как Вчера",
    "Juda Книга Очен Сегодня Нет",
    "Men Мы Плохо Я Ты",
    "U(jonsiz) Сколко? Её Она Оно",
    "Mening Плохо Мне Меня Идти",
    "Sizga Вам Пить Маленкий Карандаш",
    "Meniki Моё Человек От-куда? Мне",
    "Tong Утро Добрый Билет Вчера",
    "Xayr Пока До-свидания Небо Это",
    "Bu Школа Они Ручка Это",
    "Uchratmoq Когда? Встречать Какой? Брюки"
  ];
