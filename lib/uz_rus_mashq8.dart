...
class UzRusMashq8 extends StatefulWidget {
  const UzRusMashq8({Key? key}) : super(key: key);

  @override
  _UzRusMashq8State createState() => _UzRusMashq8State();
}

class _UzRusMashq8State extends State<UzRusMashq8> {
  ...
  List<String> list = MyHelper(
          s: "Осень (Osen) - Kuz",
          s1: "Вторник (vtornink) - Seshanba",
          s2: "Среда (sreda) - Chorshanba",
          s3: "Пятница (pyatnitsa) - Juma",
          s4: "Завтра (zavtra) - Ertag",
          s5: "Послезавтра (poslezavtra) - Indinga",
          s6: "Целый-день (cheliy den) - Kun-boyi",
          s7: "Неделя (nedlya) - Hafta",
          s8: "Месяц (mesyats) - Oy",
          s9: "Зима (zima) - Qish",
          s10: "Сегодня (segodnya) - Bugun")
      .uzPerevodRus();
