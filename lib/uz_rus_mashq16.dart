...
class UzRusMashq16 extends StatefulWidget {
  const UzRusMashq16({Key? key}) : super(key: key);

  @override
  _UzRusMashq16State createState() => _UzRusMashq16State();
}

class _UzRusMashq16State extends State<UzRusMashq16> {
  ...
  List<String> list = MyHelper(
          s: "Варан (varan) - Echkiemar",
          s1: "Ёж (ej) - Tipratikan",
          s2: "Козёл (kozyol) - Echki",
          s3: "Комар (komar) - Chivin",
          s4: "Кошка (koshka) - Mushuk",
          s5: "Курица (kuritsa) - Tovuq",
          s6: "Лев (lev) - Sher",
          s7: "Мышь (mish) - Sichqon",
          s8: "Паук (pаuk) - O`rgimchak",
          s9: "Сабока (saboka) - It",
          s10: "Цыплёнок (tsiplonek) - Jo`ja")
      .uzPerevodRus();
