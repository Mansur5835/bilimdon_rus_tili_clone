...
class RusUzMashq12 extends StatefulWidget {
  const RusUzMashq12({Key? key}) : super(key: key);

  @override
  _RusUzMashq12State createState() => _RusUzMashq12State();
}

class _RusUzMashq12State extends State<RusUzMashq12> {
  @override
