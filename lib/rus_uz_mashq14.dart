...
class RusUzMashq14 extends StatefulWidget {
  const RusUzMashq14({Key? key}) : super(key: key);

  @override
  _RusUzMashq14State createState() => _RusUzMashq14State();
}

class _RusUzMashq14State extends State<RusUzMashq14> {
  @override
  ...
  List<String> list = MyHelper(
          s: "Согласен (sonlasen) - Roziman",
          s1: "Не-делал (ne-delal) - Qilmagan",
          s2: "Не-нужно (ne-nujno) - Keraksiz",
          s3: "Ничего (nichego) - Xech-narsa",
          s4: "Не-знал (ne-znal) - Bilmasdim",
          s5: "Последний-раз (posledniy-raz) - Oxirgi-marta",
          s6: "К-сожалению (k-sojaleniyu) - Afsuski",
          s7: "Ему (emu) - Unga(erkak)",
          s8: "Это-комната? (eto-komnata) - Bu-xonami?",
          s9: "Кто-он? (kto-on) - Kim-u(erkak)",
          s10: "Кто-она? (kto-ona) - Kim-u(ayol)")
      .rusPerevodUz();
