...
class RusUzMashq18 extends StatefulWidget {
  const RusUzMashq18({Key? key}) : super(key: key);

  @override
  _RusUzMashq18State createState() => _RusUzMashq18State();
}

class _RusUzMashq18State extends State<RusUzMashq18> {
  @override
