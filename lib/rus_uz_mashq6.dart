...
class RusUzMashq6 extends StatefulWidget {
  const RusUzMashq6({Key? key}) : super(key: key);

  @override
  _RusUzMashq6State createState() => _RusUzMashq6State();
}

class _RusUzMashq6State extends State<RusUzMashq6> {
