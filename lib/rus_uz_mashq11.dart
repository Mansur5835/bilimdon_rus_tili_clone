...
class RusUzMashq11 extends StatefulWidget {
  const RusUzMashq11({Key? key}) : super(key: key);

  @override
  _RusUzMashq11State createState() => _RusUzMashq11State();
}

class _RusUzMashq11State extends State<RusUzMashq11> {
  @override
  ...
  List<String> list = MyHelper(
          s: "Высокый (visokiy) - Baland",
          s1: "Повыше (povishe) - Balandroq",
          s2: "Самый-высокый (amiy-visokiy) - Eng-baland",
          s3: "Сильный (silniy) - Kuchli",
          s4: "Крепный (krepniy) - Qattiq",
          s5: "Большой (bolshoy) - Katta",
          s6: "Тяжёлый (tjoliy) - Og`ir",
          s7: "Уважаемый (uvajayemiy) - Hutmatli",
          s8: "Умный (umniy) - Aqlli",
          s9: "Похожий (poxojiy) - O`xshash",
          s10: "Хороший (xoroshiy) - Yaxshi")
      .rusPerevodUz();
